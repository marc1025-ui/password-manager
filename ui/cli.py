...
def create_parser():
    ...
    gen.add_argument('-l', '--length', type=int, default=16, help='Longueur du mot de passe')
    gen.add_argument('--no-digits', action='store_true', help='Sans chiffres')
    gen.add_argument('--no-special', action='store_true', help='Sans caractères spéciaux')
    ...
    add.add_argument('-p', '--password', help='Mot de passe (si non spécifié, sera généré)')
